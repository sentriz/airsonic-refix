    ...
    <Hero :image="album.image">
      ...
      <div class="d-flex flex-wrap align-items-center">
        ...
        <div class="d-flex flex-nowrap">
          ...
          <ExternalLink :href="`https://redacted.sh/torrents.php?searchstr=${encodeURIComponent(formatArtists(album.artists) + ' - ' + album.name)}`" class="btn btn-link mr-2 p-0" title="Redacted">
            <IconRED />
          </ExternalLink>
        </div>
      </div>
